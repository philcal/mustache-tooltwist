...
<%--
<%@page import="tooltwist.mustache.productionHelpers.SectionProductionHelper"%>
--%>
...
//	SectionProductionHelper h = (SectionProductionHelper) helper;
//	XData data = h.getData(jh);
%>

<!-- ********** INSERT HTML HERE ********** -->
<div %%idDefinition%% class="Section" style="width:200px; border-style:solid; border-width:1px; text-align: center;">
	section
