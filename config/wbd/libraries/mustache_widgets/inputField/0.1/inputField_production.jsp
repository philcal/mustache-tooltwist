...
<%@page import="tooltwist.mustache.productionHelpers.InputFieldProductionHelper"%>
<%@page import="tooltwist.misc.JspHelper"%>
<%@page import="tooltwist.ecommerce.AutomaticUrlParametersMode"%>
<%@page import="tooltwist.ecommerce.RoutingUIM"%>
<%
	// Get the production helper for this widget
	InputFieldProductionHelper h = (InputFieldProductionHelper) helper;
	XData data = h.getData(jh);
%>

<!-- ********** INSERT HTML HERE ********** -->
<div %%idDefinition%% class="InputField" style="width:200px; border-style:solid; border-width:1px; text-align: center;">
	inputField
