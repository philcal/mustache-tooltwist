...
import tooltwist.mustache.productionHelpers.InputFieldProductionHelper;
 ...
 * Input field
 */
public class InputFieldWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "inputField_preview.html";
	private static final String SNIPPET_DESIGN = "inputField_design.html";
	private static final String SNIPPET_PRODUCTION = "inputField_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "inputField_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "inputField_jsHeader.js")),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, InputFieldProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(InputFieldProductionHelper.class.getName()));
			}
		}
