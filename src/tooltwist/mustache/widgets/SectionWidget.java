...
//import tooltwist.mustache.productionHelpers.SectionProductionHelper;
 ...
 * Mustache section
 */
public class SectionWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "section_preview.html";
	private static final String SNIPPET_DESIGN = "section_design.html";
	private static final String SNIPPET_PRODUCTION = "section_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "section_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "section_jsHeader.js")),
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, SectionProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(SectionProductionHelper.class.getName()));
			}
		}
